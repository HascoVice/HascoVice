...
<div style={{ display: 'flex', position: 'relative', width: '100%', height: '100%', background: '#04050a', borderRadius: '16px', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
  ...
  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', zIndex: 2 }}>
    ...
    <div style={{ display: 'flex', alignItems: 'center', marginTop: '14px', background: '#0a0c1490', border: '1px solid #1e293b', borderRadius: '10px', padding: '8px 16px' }}>
      ...
      <div style={{ display: 'flex', fontFamily: 'Inter', fontSize: '15px', color: '#94a3b8', marginRight: '8px' }}>~/dev $</div>
      <div style={{ display: 'flex', position: 'relative', width: '200px', height: '20px' }}>
      <div style={{ display: 'flex', position: 'absolute', left: 0, fontFamily: 'Inter', fontSize: '15px', fontWeight: 600, color: '#e2e8f0' }}>building SaaS products<animate attributeName="opacity" values="1;1;0;0;0;0;0" keyTimes="0;0.30;0.34;0.63;0.69;0.96;1" dur="9s" repeatCount="indefinite" /></div>
      <div style={{ display: 'flex', position: 'absolute', left: 0, fontFamily: 'Inter', fontSize: '15px', fontWeight: 600, color: '#a5f3fc' }}>shipping AI features<animate attributeName="opacity" values="0;0;1;1;0;0;0" keyTimes="0;0.34;0.38;0.63;0.67;1;1" dur="9s" repeatCount="indefinite" /></div>
      <div style={{ display: 'flex', position: 'absolute', left: 0, fontFamily: 'Inter', fontSize: '15px', fontWeight: 600, color: '#fbcfe8' }}>open to CDI<animate attributeName="opacity" values="0;0;1;1;0" keyTimes="0;0.67;0.71;0.96;1" dur="9s" repeatCount="indefinite" /></div>
      </div>
      <div style={{ display: 'flex', width: '2px', height: '17px', background: '#22d3ee', marginLeft: '1px' }}><animate attributeName="opacity" values="1;0;1" dur="1s" repeatCount="indefinite" /></div>
    </div>
