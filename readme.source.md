...
<div style={{ display: 'flex', position: 'relative', width: '100%', height: '100%', background: '#04050a', borderRadius: '16px', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
  <svg width="900" height="300" viewBox="0 0 900 300" style={{ position: 'absolute', top: 0, left: 0 }}>
    <defs>
      ...
      <radialGradient id="g3" cx="55%" cy="4```aura width=900 height=300 align=center
<div style={{ display: 'flex', position: 'relative', width: '100%', height: '100%', background: '#04050a', borderRadius: '16px', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
  <svg width="900" height="300" viewBox="0 0 900 300" style={{ position: 'absolute', top: 0, left: 0 }}>
    <style>{`
      @keyframes drift1 { 0%,100% { transform: translateX(-50px); } 50% { transform: translateX(50px); } }
      @keyframes drift2 { 0%,100% { transform: translateX(50px); } 50% { transform: translateX(-50px); } }
      @keyframes breathe { 0%,100% { opacity: 0.55; } 50% { opacity: 1; } }
      #blob1 { animation: drift1 11s ease-in-out infinite, breathe 5s ease-in-out infinite; }
      #blob2 { animation: drift2 14s ease-in-out infinite, breathe 7s ease-in-out infinite; }
      #blob3 { animation: breathe 6s ease-in-out infinite; }
    `}</style>
    <defs>
      <radialGradient id="g1" cx="26%" cy="32%" r="60%"><stop offset="0%" stopColor="#7c3aed" stopOpacity="0.95" /><stop offset="100%" stopColor="#04050a" stopOpacity="0" /></radialGradient>
      <radialGradient id="g2" cx="76%" cy="70%" r="55%"><stop offset="0%" stopColor="#06b6d4" stopOpacity="0.9" /><stop offset="100%" stopColor="#04050a" stopOpacity="0" /></radialGradient>
    ...
    <ellipse id="blob1" cx="240" cy="90" rx="340" ry="200" fill="url(#g1)" />
    <ellipse id="blob2" cx="670" cy="190" rx="320" ry="190" fill="url(#g2)" />
    <ellipse id="blob3" cx="450" cy="140" rx="260" ry="160" fill="url(#g3)" />
...
<div style={{ display: 'flex', flexDirection: 'column', width: '100%', height: '100%', background: '#0a0c14', borderRadius: '16px', padding: '24px 28px', fontFamily: 'Inter' }}>
  ...
  <div style={{ display: 'flex', flexDirection: 'column', width: '264px', background: '#11141d', border: '1px solid #a78bfa33', borderRadius: '12px', padding: '18px 18px', marginRight: '18px', position: 'relative', overflow: 'hidden' }}>
    ...
    <div style={{ display: 'flex', fontSize: '12px', color: '#94a3b8', lineHeight: '1.55' }}>J'utilise l'IA (Mistral, GPT-4o, Claude Code) pour accélérer mon dev — mais toujours avec review et de manière sécurisée, jamais en aveugle.</div>
  </div>
...
```
8%" r="45%"><stop offset="0%" stopColor="#f472b6" stopOpacity="0.45" /><stop offset="100%" stopColor="#04050a" stopOpacity="0" /></radialGradient>
    </defs>
    <rect x="0" y="0" width="900" height="300" fill="#04050a" />
